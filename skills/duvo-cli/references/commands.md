...
| `duvo clarity build-automation <process-id> [--proposal-id <id>] [--json]`                                                                                                              | Start automation generation from a transformation proposal. `--proposal-id` picks a snapshot; defaults to the live proposal.                                                        |
