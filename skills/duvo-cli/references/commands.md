...
| Command                                                                                                                                                                                                                         | Purpose                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `duvo cases list --queue <id> [--limit <n>] [--offset <n>] [--status <list>] [--priority <list>] [--search <text>] [--created-at-from <iso>] [--updated-at-from <iso>] [--sort-by <field>] [--sort-order <asc\|desc>] [--json]` | List cases in a queue with filters. `--priority` is comma-separated (`none`, `medium`, `high`).                                                         |
...
| `duvo pulse send-message <id> --message <text> [--json]`                                                | Send a follow-up instruction to a Pulse dashboard (max 15000 chars), triggering a new generation. Creator only.                                                                                                                                                                                                                                                  |
