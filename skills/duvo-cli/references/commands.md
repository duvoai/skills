...
| `duvo pulse refresh-schedule <id> --frequency <freq> [--json]`                                          | Set how often a dashboard auto-refreshes in the background (creator only). `--frequency` is one of `every_15_minutes`, `every_30_minutes`, `hourly`, `every_6_hours`, `daily`, `weekly`, `off`.                                                                                                                                                                  |
